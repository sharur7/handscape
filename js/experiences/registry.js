...
export const EXPERIENCES = [
  ...
  { id: "candle", name: "Candlelight", tag: "pucker to blow out", icon: "🕯️", status: "ready", create: createCandle,
    info: "<b>Pucker your lips</b> at the camera to blow the flame out. <b>Pinch twice</b> (lighter spark) to relight. Needs the camera." },
  { id: "balloon", name: "Balloon Pump", tag: "pucker to pump · pinch to tie", icon: "🎈", status: "ready", create: createBalloon,
    info: "<b>Pucker</b> to blow it up (it leaks when you stop). <b>Pinch</b> to tie it off in the green sweet-spot for a bonus — don't pop it! Needs the camera." },
  ...
  { id: "booth", name: "Photo Booth", tag: "face props · pinch to swap", icon: "😎", status: "ready", create: createPhotoBooth,
    info: "Your camera shows with <b>face-tracked props</b> (glasses, hats, octopus…). <b>Pinch</b> to change, <b>smile</b> for sparkles. Needs the camera." },
  { id: "makeface", name: "Copycat Faces", tag: "copy the expression", icon: "🤪", status: "ready", create: createMakeFace,
    info: "Copy the <b>expression</b> shown (smile, surprise, tongue out, puff cheeks, wink…). Match it to score. Needs the camera." },
